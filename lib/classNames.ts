...
export const sectionHeadingClassName =
  'font-sans text-title-lg font-semibold leading-none tracking-[-0.04em] text-(--color-ink) dark:text-white sm:text-display-sm lg:text-display'
...
export const sectionClassName =
  'mt-8 border-t border-(--color-line) pt-10 sm:mt-10 sm:pt-14'
